...
words = {'butterfly': 'One wonders if this fly got its name from landing in a pat of this.',
         ...
         'rain': 'This weather can ruin a pinic or an outdoor event.',
         'puppy': 'This is a baby dog.',
         'bed': 'Some people believe if you make this up in the morning, your day will start off right.'}

# Need to choose one of the words randomly for the game answer, hint = random.choice(list(words.items()))
...
while guess != answer:
    tries -= 1
    print('That\'s not quite it. You have {} tries left. Try again!'.format(tries))
